...
saved_2igd_rst7_file = get_fn('2igd/2igdab.LES.rst7')
saved_2igd_prmtop_file = get_fn('2igd/2igdab.LES.prmtop')
saved_2igd_pdb_file = get_fn('2igd/2igdab_4phenix.LES.pdb')
saved_2igd_mtz_file = get_fn('2igd/2igd.mtz')
